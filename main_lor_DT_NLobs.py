...
f, h, h_nonlinear, hRotate, H_Rotate, H_Rotate_inv, Q_structure, R_structure
...
traj_resultName = ['traj_lorDT_NLobs_rq1030_T100.pt']
dataFileName = ['data_lor_NLobs_v20_rq1030_T100.pt']
...
change_point_params = {
   ...
   'H': h_nonlinear                 # used if changed_param == 'H' (alternative observation)
}
...
# sys_model = SystemModel(f, Q, h_nonlinear, R, args.T, args.T_test, m, n) # original (no CPD)
sys_model = SystemModel(
   f, Q, h_nonlinear, R, args.T, args.T_test, m, n,
   Q_afterCPD=change_point_params.get('Q', Q),
   f_afterCPD=change_point_params.get('F', f),
   h_afterCPD=change_point_params.get('H', h_nonlinear),
...
# Model with partial info (using nonlinear observation)
sys_model_partial = SystemModel(f, Q, h_nonlinear, R, args.T, args.T_test, m, n)
sys_model_partial.InitSequence(m1x_0, m2x_0)
# Model for 2nd pass
sys_model_pass2 = SystemModel(f, Q, h_nonlinear, R, args.T, args.T_test, m, n)# parameters for GT
...
# the dataset.
CPDDatafolderName = 'CPDNet_lor_NLobs/'
CPDDatafileName = 'data_lor_NLobs_v20_rq1030_T100.pt'
path_results_CPD = 'CPDNet_lor_NLobs/'

sys_model_CPD = SystemModel(f, Q, h_nonlinear, R, args.T, args.T_test, m, n, 
                           args.T_test,
                           Q_afterCPD=change_point_params.get('Q', Q),  
                           f_afterCPD=change_point_params.get('F', f),    
                           h_afterCPD=change_point_params.get('H', h_nonlinear),
...
## Train Neural Network
CPD_Pipeline = Pipeline_CPD(strTime, "CPDNet_lor_NLobs", "CPDNet")
...
# Load CPDNet model
sys_model_online = SystemModel(f, Q, h_nonlinear, R, args.T, args.T_test, m, n, 
                           args.T_test,
                           Q_afterCPD=change_point_params.get('Q', Q),  
                           f_afterCPD=change_point_params.get('F', f),    
                           h_afterCPD=change_point_params.get('H', h_nonlinear),
...
sys_model_KF = SystemModel(f, Q, h_nonlinear, R, args.T, args.T_test, m, n, 
                           args.T_test,
                           Q_afterCPD=change_point_params.get('Q', Q),  
                           f_afterCPD=change_point_params.get('F', f),    
                           h_afterCPD=change_point_params.get('H', h_nonlinear),
...
unsupervised_pipeline.setCPDNet('CPDNet_lor_NLobs')
...
ekf_changeparameters = {
    ...
    'H': change_point_params.get('H', h_nonlinear),
